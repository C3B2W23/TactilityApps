...
**Build profile:** `single_app_large`, flash size **16MB**; current firmware artifact `MesholaMessenger.bin` ~1.07 MB (RadioLib + compat stubs bundled). Default MeshCore Public channel is baked in (Hex: `8b3387e9c5cdea6ac9e5edbaa115cd72`, Base64: `izOH6cXN6mrJ5e26oRXNcg==`).
---
## Key Features
### Current (v0.1.0)
