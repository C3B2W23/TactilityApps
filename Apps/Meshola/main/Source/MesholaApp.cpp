...
void MesholaApp::onShow(tt::AppHandle handle, lv_obj_t* parent) {
    TT_LOG_I(TAG, "onShow");
    _handle = handle;
    _parent = parent;
    ...
    tt::lvgl::toolbar_create_for_app(parent, handle);
...
void MesholaApp::onHide(tt::AppHandle handle) {
    TT_LOG_I(TAG, "onHide");
