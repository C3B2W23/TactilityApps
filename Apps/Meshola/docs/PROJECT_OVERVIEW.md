...
4. **Runs on T-Deck hardware** - Optimized for ESP32-S3 with physical keyboard and 320x240 display
5. **Enables community building** - Support local mesh communities with easy setup and reliable messaging
---
## Target Hardware
